...
@section('content')
    <section class="k-login uk-width-1-1 uk-cover-container">
        <img src="{!! asset('assets/img/wilhelminabrug.jpg') !!}" alt="login" uk-cover>
        <div class="uk-overlay-primary uk-position-cover"></div>
        <div class="uk-overlay uk-overlay-default uk-position-center uk-width-1-4">
            <img class="uk-border-circle uk-align-center" src="{!! asset('assets/img/favicon.png') !!}" width="100" height="100" alt="Login">
        ...
        <footer class="k-footer uk-position-bottom uk-text-center">
            Copyright &copy; <?php echo date('Y'); ?> <a class="" href="" target="_blank" title="Site Name">Site Name</a> | Powered by <a class="" href="http://kleur.id" target="_blank" title="Kleur CMS">Kleur CMS</a>
        </footer>
    </section>
@endsection
